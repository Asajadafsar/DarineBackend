...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,193.5.44.190,api.darine.shop,darine.shop').split(',')
...
CORS_ALLOWED_ORIGINS = [
    ...
    # HTTP
    "http://api.darine.shop",
    "http://silver.darine.shop",
    "http://gold.darine.shop",
    "http://darine.shop",
    "http://www.darine.shop",

    # Local development
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://193.5.44.190:3000",
]
...
SECURE_SSL_REDIRECT = False      # این خط را به False تغییر دهید
SESSION_COOKIE_SECURE = False    # این خط را به False تغییر دهید
CSRF_COOKIE_SECURE = False       # این خط را به False تغییر دهید