...
class GiftCardOrderAPIView(APIView):
    ...
    def post(self, request):
        ...
        weight_per_card = Decimal(
            str(serializer.validated_data['weight_per_card'])
        )
        ...
        total_price = total_weight * gold_price
...
class UserAddressesAPIView(APIView):
    ...
    def get(self, request):
        ...
        order_addresses = Order.objects.filter(
            user=request.user
        ).values(
            'province',
            'city',
        ...
        gift_addresses = GiftCardOrder.objects.filter(
            user=request.user
        ).values(
            'province',
            'city',
