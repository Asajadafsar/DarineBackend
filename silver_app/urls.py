...
from .views import (
    ...
    SilverInvoiceDetailAPIView,
    SilverInvoiceDownloadPDFAPIView,
    SilverInvoiceListAPIView,
...
path(
    ...
    path('invoices/', SilverInvoiceListAPIView.as_view(), name='silver-invoice-list'),
    path('invoices/<int:invoice_id>/', SilverInvoiceDetailAPIView.as_view(), name='silver-invoice-detail'),
    path('invoices/<int:invoice_id>/download/', SilverInvoiceDownloadPDFAPIView.as_view(), name='silver-invoice-download-pdf'),
