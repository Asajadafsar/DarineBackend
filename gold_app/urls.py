...
from .views import (
    ...
    GoldGuaranteeCancelView,
    GoldGuaranteeCreateView,
    GoldGuaranteeDetailView,
    GoldGuaranteeExecuteView,
    GoldGuaranteeInfoView,
    GoldGuaranteeListView,
    GoldGuaranteePlansView,
    GoldInvestmentCancelView,
    GoldInvestmentCollectProfitView,
    GoldInvestmentConfirmView,
    GoldInvestmentCreateView,
    GoldInvestmentDetailView,
    GoldInvestmentInfoView,
    GoldInvestmentListView,
    GoldInvestmentPlansView,
    GoldInvestmentPreviewView,
    ...
    PhysicalOrderInvoiceDetailView,
    PhysicalOrderInvoiceDownloadView,
    PhysicalOrderInvoiceListView,
...
urlpatterns = [
    ...
    path('guarantee/list/', GoldGuaranteeListView.as_view(), name='gold-guarantee-list'),
